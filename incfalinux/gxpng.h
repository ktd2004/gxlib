...
extern png_t  *gx_png_open  ( char  *filename);             	                // png 객체를 생성한 후에, 파일을 오픈
extern png_t  *gx_png_create( int   width, int height);     	                // png 객체를 파일없이 생성
extern void    gx_png_close ( png_t *ppng);                                     // 파일을 클로즈 및 png 객체 소멸
