...
void FontChanged( FILE *file, bdfFontCache* pCache)
{
	int n, i;
	int nIncrease;
	...
	fndex[INDEX_MAX-1].nCode = 0xFFFF;
	fndex[INDEX_MAX-1].nPos = n;
}
int ReadFontOfCode( bdfFontCache* pCache, FILE* file ,unsigned int nCode ,pbdfFont pRetFont )
{
	int i;
